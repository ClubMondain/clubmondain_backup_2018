        ...
        <div class="dashboard-main">
        	<div class="left">
            	...
            	<div class="single-content">
                	<div class="dashboard-head">
                    	<h2>  My Class</h2>
                        <a href="<?php echo base_url('Main/list-class-view');?>">Class LIST</a>
                    </div>
          ...
          <?php }?>
                    <div class="details-form">
						...
						<?php echo form_open_multipart('Main/update_class/'.base64_encription($all_data[0]['trainer_class_id']),$formDetails);?>
                        <div class="row">
                          <div class="col-sm-6">
                             <div class="single">
                                <p>Name of Class<span style="color:#F00">*</span>
                                   <a class="tooltip-btn" title="Official name Business"><i class="fa fa-info-circle"></i></a>
                                </p>
                                <div class="form-row">
                                <div class="field">
                            ...
                            <div class="single">
                              <p>Category<span style="color:#F00">*</span>
                                <a class="tooltip-btn" title="Insert the Category item"><i class="fa fa-info-circle"></i></a>                          	  </p>
                                <div class="form-row">
                                    <div class="field">
                                     <div class="select">
                        ...
                        <div class="row">
                          <div class="col-sm-6">
                                <div class="single">
                            <p>Website
                            	<a class="tooltip-btn" title="Insert the website"><i class="fa fa-info-circle"></i></a>
                            </p>
                            <div class="form-row">
                                <div class="field">
                          ...
                          <div class="col-sm-6">
             				 <div class="single">
                                <p>Price of Class<span style="color:#F00">*</span> <a class="tooltip-btn" title="Insert Price For Classes"><i class="fa fa-info-circle"></i></a> </p>
                                <div class="form-row">
                                  <div class="field">
                                ...
                                <div class="select">
                                    ...
                                    <option value="">Choose Country</option>
                                     <?php foreach($country as $country){?>
									   ...
									   <?php if($all_data[0]['trainer_class_country'] == $country['country_name']){?> selected <?php }?>><?php echo $country['country_name'];?></option>
                                      <?php }?>
                                    </select>
                    	...
                    	<div class="col-sm-6">
                         ...
                         <div class="row">
                            ...
                            <div class="single">
                                <p> Address
                                	<a class="tooltip-btn" title="Insert the address of the health item"><i class="fa fa-info-circle"></i></a>
                                </p>
                                <div class="form-row">
                                    <div class="field">
              ...
              <div class="single">
                ...
                <div class="form-row">
                  <div class="field">
                    <input type="number" name="class_no_of_booking" id="class_no_of_booking" value="<?php echo $all_data_only[0]['class_no_of_booking'];?>" class="trainer_class_address">
                  </div>
                </div>
              </div>
            </div>
                    	  ...
                    	  <div class="col-sm-6">
                        		<div class="single">
                            <p>Class Image<span style="color:red">*</span>
                            	<a class="tooltip-btn" title="Business image/banner should be max 5mb"><i class="fa fa-info-circle"></i></a>
                            </p>
                            <div class="form-row">
                                <div class="field">
                                    <div class="upload">
                                ...
                                <div class="select">
                                  <select class="city_list" name="event_id" id="event_id">
                                    ...
                                    <?php foreach($allEvent as $allEvent){?>
                                        <option value="<?php echo $allEvent['business_id'];?>" <?php if($all_data[0]['event_id'] == $allEvent['business_id']){?> selected <?php }?>><?php echo $allEvent['business_name'];?></option>
                                    <?php }?>
                                  </select>
                                </div>
                              </div>
                        ...
                        <div class="row">
                        	<div class="col-sm-12">
                                ...
                                <p>Description<span style="color:#F00">*</span>
                                   <a class="tooltip-btn" title="Insert the Description"><i class="fa fa-info-circle"></i></a>
                                </p>
                                <div class="form-row">
                                    <div class="field">
                    ...
                    <div class="col-sm-12 col-centered">
                		<div class="single">
                        	<div class="form-row">
                        	<div class="field">
                                <button type="submit" onClick="return ClassValidation();">UPDATE CLASS DETAILS</button>
                            </div>
                        </div>
                   		</div>
                    </div>
