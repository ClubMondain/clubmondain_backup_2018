...
<?php if(count($allClass)>0){?>
<div class="all-trainer-classes">
<div class="row">
<?php foreach($allClass as $allClass){?>
...
<p class="price">&euro;<?php echo $allClass['trainer_class_price'];?></p>
<div class="join-btn"> <a href="<?php echo base_url('Home/trainer-details-classes/').base64_encription($allClass['trainer_class_id']);?>">Book this class</a> </div>
</div>
</div>
</div>
<?php }?>
...
<div class="no_data"><h2>No Classes Available</h2></div>
<?php }?>
</div>
</div>
<div class="sidebar">
