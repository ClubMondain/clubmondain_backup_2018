                        ...
                        <div class="form-row">
                        	<div class="field">
                            	<div class="all-check">
                                    <div class="check">
                                    <?php                                   
                                     //in_array("client_check", $company_about_us)
                                    ?>
                                        <input type="checkbox" id="company_about_check1" name="company_about_us[]" value="client_check" class="company_about_us" <?php if(!empty($full_profile[0]['about_us'])){ if(in_array("client_check", $company_about_us) ){ ?>checked <?php } }?>> <label for="company_about_check1">Client of ours</label>
                                    </div>
                                    <div class="check">
                                    
                                        <input type="checkbox" id="company_about_check2" name="company_about_us[]" value="aricle_check" class="company_about_us" <?php if(!empty($full_profile[0]['about_us'])){  if(in_array("aricle_check", $company_about_us) ){ ?>checked <?php }}?>>
                                        <label for="company_about_check2">News Article</label>
                                    </div>
                                    <div class="check">
                                    
                                        <input type="checkbox" id="company_about_check3" name="company_about_us[]" value="other_check" class="company_about_us" <?php if(!empty($full_profile[0]['about_us'])){if(in_array("other_check", $company_about_us) ){ ?>checked <?php } } ?>>
