      ...
      <div class="col-md-12">
        ...
        <div class="col-md-12"> 
          ...
          <div class="box box-primary"> 
            ...
            <?php echo form_open_multipart('Event/update-event/'.$dataSection[0]['event_id'],$formDetails);?>
            <input type="hidden" name="old_picture" value="<?php echo $dataSection[0]['event_banner']; ?>">
            <div class="row">
              <div class="col-md-6">
                <div class="box-body">
                  <label for="name">Event Name<span style="color:red">*</span></label>
                  <input type="text" class="form-control" name="event_name" value="<?php echo $dataSection[0]['event_name']; ?>" id="event_name" placeholder="Event Name">
                </div>
              </div>
              <div class="col-md-6">
                <div class="box-body">
              ...
              <div class="col-md-6">
                <div class="box-body">
                  ...
                  <input type="text" class="form-control" name="event_website_url" value="<?php echo $dataSection[0]['event_website_url']; ?>" id="event_website_url" placeholder="Event Website">
                </div>
              </div>
               <div class="col-md-6">
                  <div class="box-body">
                  ...
                  <option value="<?php echo $timezone['timezid'];?>" <?php if($dataSection[0]['timezone_id'] == $timezone['timezid']){?> selected <?php } ?> ><?php echo $timezone['gmt'];?></option>
                    <?php } } ?>
                  </select>
                  </div>
                  </div>
                ...
                <div class="col-md-6">
                  ...
                  <label for="exampleInputAddress">Short Description<span style="color:red">*</span></label>
                    <textarea class="form-control" name="event_description" value="" id="event_description" placeholder="Short Description" rows="6"><?php echo $dataSection[0]['event_description']; ?></textarea>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="box-body">
                    <label for="exampleInputAddress">Venue Facilities<span style="color:red">*</span></label>
                    <textarea class="form-control" name="event_facilities" value="" id="event_facilities" placeholder="Venue Facilities" rows="6"><?php echo $dataSection[0]['event_facilities']; ?></textarea>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="box-body">
                ...
                <div class="col-md-4">
                  <div class="box-body">
                    ...
                    <input type="text" class="form-control" name="event_adress" value="<?php echo $dataSection[0]['event_adress']; ?>" id="autocomplete" placeholder="Event Address">
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="box-body">
                    <label for="name">Event Start Date<span style="color:red">*</span></label>
                    <input type="text" class="form-control dp" name="event_date_from" value="<?php echo $dataSection[0]['event_date_from']; ?>" id="event_date_from" placeholder="0000-00-00">
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="box-body">
                    <label for="name">Event End Date<span style="color:red">*</span></label>
                    <input type="text" class="form-control dp" name="event_date_to" value="<?php echo $dataSection[0]['event_date_to']; ?>" id="event_date_to" placeholder="0000-00-00">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="box-body">
                ...
                <div class="col-md-6">
                  <div class="box-body">
                    <div class="upload">
                      <label for="event_pic" id="photo-img-label">Banner Picture</label>
                 ...
                 <div class="col-md-12">
                  ...
                  <label for="exampleInputAddress">Condition for Event</label>
                    <textarea class="form-control" name="event_free_text" id="event_free_text" placeholder="Free Text" rows="6"><?php echo $dataSection[0]['event_free_text']; ?> </textarea>
                  </div>
                </div>
              </div>
