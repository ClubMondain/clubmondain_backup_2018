      ...
      <div class="col-md-12">
        ...
        <div class="col-md-12"> 
          ...
          <div class="box box-primary"> 
            <!-- /.box-header --> 
            <!-- form start -->
            <?php $formDetails = array('id'=>'edit_space','method'=>'post','class'=>'','name'=>'insert_event');?>
            <?php echo form_open_multipart('Space/update-space/'.$dataSection[0]['business_id'],$formDetails);?>
            <div class="row">
             ...
             <div class="col-md-6">
                <div class="box-body">
                  ...
                  <input type="text" class="form-control" name="business_name" value="<?php echo $dataSection[0]['business_name']; ?>" id="business_name" placeholder="Space Name">
                </div>
              </div>
              ...
              <div class="col-md-12">
                  ...
                  <label for="exampleInputAddress">Space Description</label>
                    <textarea class="form-control" name="business_description" value="" id="business_description" placeholder="Space Description" rows="6"><?php echo $dataSection[0]['business_description']; ?> </textarea>
                  </div>
                </div>
                ...
                <div class="box-body">
                  ...
                  <input type="text" class="form-control" name="business_website_url" value="<?php echo $dataSection[0]['business_website_url']; ?>" id="business_website_url" placeholder="Space Website URL">
                </div>
              </div>
               ...
               <div class="col-md-6">
                <div class="box-body">
                  ...
                  <input type="text" class="form-control" name="business_street" value="<?php echo $dataSection[0]['business_street']; ?>" id="autocomplete" onFocus="geolocate()" placeholder="Space Business">
                </div>
              </div>
              ...
              <div class="col-md-6">
                <div class="box-body">
                  ...
                  <input type="text" class="form-control" name="business_postal_code" value="<?php echo $dataSection[0]['business_postal_code']; ?>" id="business_postal_code" placeholder="Postal Code">
                </div>
              </div>
                 ...
                 <div class="col-md-6">
                  ...
                  <div class="box-body">
                    ...
                    <select class="form-control" name="business_status" id="business_status">
                        ...
                        <option value="Active" <?php if($dataSection[0]['business_status'] == 'Active'){?> selected <?php } ?>>Active</option>
                        <option value="Inactive" <?php if($dataSection[0]['business_status'] == 'Inactive'){?> selected <?php } ?>>Inactive</option>
                      </select>
                    </div>
                  </div>
                </div>
