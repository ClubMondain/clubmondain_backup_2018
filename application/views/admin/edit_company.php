						...
						<div class="row">
							<div class="col-md-12"> 
								<div class="box box-primary">
									...
									<?php echo form_open('Dashboard/company-profile-update/'.$all_members[0]['user_id'].'',$formDetails);?>
									<div style="color:#F00"><?php  //echo validation_errors(); ?></div>
									<input type="hidden" name="date_reg" value="<?php echo date("d-m-Y");?>">
									<div class="row">
										<div class="col-md-6">
											<div class="box-body">
												<label for="member_username">Company Name<span style="color:red">*</span></label>
												<input type="text" class="form-control" name="company_name" value="<?php echo $all_members[0] ['company_name']?>" id="company_name" placeholder="Company Name" maxlength="25" minlength="2">
											</div>
										</div>
										...
										<div class="col-md-6">
											<div class="box-body">
												<label for="exampleInputEmail">Company Person</label>
												<input type="text" class="form-control" name="company_person" value="<?php echo $all_members[0]['company_person']; ?>" placeholder="Company Person" id="company_person">
											</div>
										</div>
										...
										<div class="col-md-12">
											<div class="box-body">
										<label for="exampleInputEmail">Company Description</label>
												<textarea class="form-control" name="company_description" value="" id="company_description" placeholder="Company Description" rows="6"><?php echo strip_tags($all_members[0]['company_description']); ?></textarea>
											</div>
										</div>
