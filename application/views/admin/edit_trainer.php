						...
						<div class="row">
							<div class="col-md-12"> 
								<div class="box box-primary">
									...
									<?php echo form_open('Dashboard/trainner-profile-update/'.$all_members[0]['user_id'].'',$formDetails);?>
									...
									<div class="row">
										...
										<div class="col-md-12">
											<div class="box-body">
										<label for="exampleInputEmail">Trainer Experience</label>
												<textarea class="form-control" name="trainer_experience" value="" id="trainer_experience" placeholder="About Us" rows="6"><?php echo strip_tags($all_members[0]['trainer_experience']); ?></textarea>
											</div>
										</div>
										<div class="col-md-12">
											<div class="box-body">
												<label for="exampleInputEmail">Trainer About Yourself</label>
												<textarea class="form-control" name="trainer_about_yourself" value="" id="trainer_about_yourself" placeholder="Trainer About Yourself" rows="6"><?php echo strip_tags($all_members[0]['trainer_about_yourself']); ?></textarea>
											</div>
										</div>
										<div class="col-md-6">
											<div class="box-body">
