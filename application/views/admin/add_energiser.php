...
<h1>Create Delegate Energizer</h1>
</section>
<!-- Main content -->
...
<div class="col-md-12"> 
  ...
  <div class="box box-primary"> 
    ...
    <?php echo form_open_multipart('InviteSpace/insert_energiser',$formDetails);?>
      <div class="row">
      
      
        <div class="col-md-12">
          <div class="box-body">
            <label for="name">Select Delegate Invite for Energizer<span style="color:red">*</span></label>
            <div class="select">
            <select class="form-control" name="space_id" id="space_id">
            <option value="">Select Delegate Invite for Energizer</option>
            <?php 
            if(count($invite_space) > 0){
            for($i=0; $i<count($invite_space);$i++) { ?>
            <option value="<?php echo $invite_space[$i]['business_id'];?>"><?php echo $invite_space[$i]['business_name'];?></option>
              <?php } } ?>
            </select>
            </div>
          </div>
      ...
      <div class="col-md-6">
        <div class="box-body">
          ...
          <input type="text" class="form-control" name="trainer_class_name" value="" id="trainer_class_name" placeholder="Name of Delegate Energizer">
        </div>
      </div>
      ...
      <div class="col-md-6">
        ...
        <div class="box-body">
          ...
          <input type="text" class="form-control" name="trainer_class_website_url" value="" id="trainer_class_website_url" placeholder="Delegate Energizer Website URL">
        </div>
      </div>
        ...
        <div class="box-body">
          ...
          <input type="text" class="form-control" name="trainer_class_address" value="" id="trainer_class_address" onFocus="geolocate()" placeholder="Delegate Energizer Address">
        </div>
      </div>

     <!-- <div class="col-md-6">
        <div class="box-body">
          <label for="name">Price Of Energiser<span style="color:red">*</span></label>
          <input type="text" class="form-control" name="trainer_class_price" value="" id="trainer_class_price" placeholder="Price Of Class">
        </div>
      </div>-->
      ...
      <div class="col-md-6">
        <div class="box-body">
          ...
          <input type="text" class="form-control" name="class_no_of_booking" value="" id="class_no_of_booking" placeholder="Number Of Booking">
        </div>
      </div>
     ...
     <div class="col-md-6">
      ...
      <div class="col-md-12">
          <div class="box-body">
          <label for="exampleInputAddress">Delegate Energizer Description<span style="color:red">*</span></label>
            <textarea class="form-control" name="trainer_class_description" value="" id="trainer_class_description" placeholder="Delegate Energizer Description" rows="6"></textarea>
          </div>
        </div>
