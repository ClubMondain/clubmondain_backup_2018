<?php
$page_title = 'List Of Delegate Energizer Statistics';
include('inc/top.php');
?>
            ...
            <div class="box-body">
              <div class="table-responsive">
                <table id="example1" class="table table-bordered table-striped text-center">
                  <thead>
                    <tr>
                      ...
                      <th>No of People Invited</th> 
                      <th>No of People Joined</th> 
                     <th>View Joined People</th>
                     <!-- <th>Action</th>-->
                    </tr>
                  </thead>
                <?php
                ...
                <tr>                   			
					...
					<td><?php echo getCompanyname(get_invite_space_company_name($val['space_id']));?></td>
                    <td><?php  echo getInvitedPeople($val['space_id']); ?></td> 
                    <td><?php  echo getEnergizerJoinedPeople($val['trainer_class_id']); ?></td> 
                    <th><a href="<?php echo base_url()?>InviteSpace/list_energiser_joined_user/<?php echo $val['trainer_class_id'];?>" class="btn btn-info">View</a></th>
