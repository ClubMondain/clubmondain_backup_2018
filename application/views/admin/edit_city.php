          ...
          <div class="row">
            ...
            <div class="col-md-12"> 
              ...
              <div class="box box-primary">
				...
				echo form_open_multipart('City/update-city/'.$dataSection[0]['city_id'],$formDetails);
				?>
                <div class="row">
                <div class="col-md-4">
                    <div class="box-body">
                  ...
                  <div class="col-md-4">
                    <div class="box-body">
                      ...
                      <input type="text" class="form-control" name="city_name" value="<?php echo $dataSection[0]['city_name']; ?>" id="city_name" placeholder="City Name">
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="box-body">
                  ...
                  <div class="col-md-12">
                    <div class="box-body">
                      ...
                      <select class="form-control" name="city_status" id="city_status">
                        ...
                        <option value="Active" <?php if($dataSection[0]['city_status'] == 'Active'){?> selected <?php } ?>>Active</option>
                        <option value="Inactive" <?php if($dataSection[0]['city_status'] == 'Inactive'){?> selected <?php } ?>>Inactive</option>
                      </select>
                    </div>
                  </div>
                </div>
