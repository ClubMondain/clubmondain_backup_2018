<aside class="main-sidebar">
 ...
 <!----ADD BY SUBHASIS (FOR INVITE SPACE START)-------------> 
 <li class="treeview <?php if( $_ci_view == 'admin/edit_space_feedback' || $_ci_view == 'admin/list_space_feedback' || $_ci_view == 'admin/space' || $_ci_view == 'admin/edit_space'|| $_ci_view == 'admin/list_all_space' || $_ci_view == 'admin/list_space'){ echo 'active open';} ?>"> <a href=""> <i class="fa fa-gg-circle"></i> <span>Delegate Space</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
        <ul class="treeview-menu">
          <li class="<?php if($_ci_view == 'admin/space'){?> active-menue <?php }?>"><a href="<?php echo site_url('InviteSpace/create_space_view/');?>"> <i class="fa fa-circle-o"></i><span>Create Delegate Space</span></a> </li>
          
          <li class="<?php if($_ci_view == 'admin/list_all_space'){?> active-menue <?php }?>"><a href="<?php echo site_url('InviteSpace/list_invite_space');?>"> <i class="fa fa-circle-o"></i><span>List Of All Delegate Space</span></a> </li>
          
        </ul>
      </li>
<!----ADD BY SUBHASIS (FOR INVITE SPACE END)------------->

 <!----ADD BY SUBHASIS (FOR ENERGISER  START)-------------> 
 <li class="treeview <?php if( $_ci_view == 'admin/edit_space_feedback' || $_ci_view == 'admin/list_space_feedback' || $_ci_view == 'admin/space' || $_ci_view == 'admin/edit_space'|| $_ci_view == 'admin/list_all_space' || $_ci_view == 'admin/list_space'){ echo 'active open';} ?>"> <a href=""> <i class="fa fa-gg-circle"></i> <span>Delegate Energizer</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
        <ul class="treeview-menu">
          <li class="<?php if($_ci_view == 'admin/space'){?> active-menue <?php }?>"><a href="<?php echo site_url('InviteSpace/add_energiser/');?>"> <i class="fa fa-circle-o"></i><span>Create Delegate Energizer</span></a> </li>
          
          <li class="<?php if($_ci_view == 'admin/list_all_space'){?> active-menue <?php }?>"><a href="<?php echo site_url('InviteSpace/list_energiser');?>"> <i class="fa fa-circle-o"></i><span>List Of All Delegate Energizer</span></a> </li>
          
          
          <li class="<?php if($_ci_view == 'admin/list_all_space'){?> active-menue <?php }?>"><a href="<?php echo site_url('InviteSpace/list-energiser-statistics');?>"> <i class="fa fa-circle-o"></i><span>Energizer Statistics</span></a> </li>
          
        </ul>
      </li>
      
<!----ADD BY SUBHASIS (FOR ENERGISER  END)------------->
...
<li class="treeview <?php if( $_ci_view == 'admin/edit_space_feedback' || $_ci_view == 'admin/list_space_feedback' || $_ci_view == 'admin/space' || $_ci_view == 'admin/edit_space'|| $_ci_view == 'admin/list_all_space' || $_ci_view == 'admin/list_space'){ echo 'active open';} ?>"> <a href=""> <i class="fa fa-gg-circle"></i> <span>Space</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
        <ul class="treeview-menu">
          <li class="<?php if($_ci_view == 'admin/space'){?> active-menue <?php }?>"><a href="<?php echo site_url('Space/create_space_view/');?>"> <i class="fa fa-circle-o"></i><span>Create Space</span></a> </li>
          ...
          <li class="<?php if($_ci_view == 'admin/list_all_space'){?> active-menue <?php }?>"><a href="<?php echo site_url('Space/list_all_space_view');?>"> <i class="fa fa-circle-o"></i><span>List All Space</span></a> </li>
     ...
     <?php /*?> <li class="treeview <?php if($_ci_view == 'admin/event' || $_ci_view == 'admin/edit_event'|| $_ci_view == 'admin/list_all_event' || $_ci_view == 'admin/list_event'){ echo 'active open';} ?>"> <a href=""> <i class="fa fa-gg-circle"></i> <span>My Event</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
      ...
      <li class="treeview <?php if($_ci_view == 'admin/event' || $_ci_view == 'admin/edit_event'|| $_ci_view == 'admin/list_all_event' || $_ci_view == 'admin/list_event'){ echo 'active open';} ?>"> <a href=""> <i class="fa fa-gg-circle"></i> <span>Event</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
        <ul class="treeview-menu">
          <li class="<?php if($_ci_view == 'admin/event'){?> active-menue <?php }?>"><a href="<?php echo site_url('Event/create-event-view/');?>"> <i class="fa fa-circle-o"></i><span>Create Events</span></a> </li>
         <!--  <li class="<?php if($_ci_view == 'admin/list-event'){?> active-menue <?php }?>"><a href="<?php echo site_url('Event/list-event-view');?>"> <i class="fa fa-circle-o"></i><span>List Event By Admin</span></a> </li> -->
          <li class="<?php if($_ci_view == 'admin/list-all-event'){?> active-menue <?php }?>"><a href="<?php echo site_url('Event/list-all-event-view');?>"> <i class="fa fa-circle-o"></i><span>List All Event</span></a> </li>
        </ul>
      </li>
