...
<div class="col-md-12"> 
  ...
  <div class="box box-primary"> 
    ...
    <?php echo form_open_multipart('InviteSpace/update_invite_space/'.$all_data[0]['business_id'],$formDetails);?>
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="box-body">
            ...
            <option value="<?php echo $val->user_id;?>" <?php if( $val->user_id == $all_data[0]['user_id']){ ?> selected="" <?php } ?> ><?php echo $val->company_name;?></option>
              <?php } } ?>
            </select>
            </div>
          </div>
        ...
        <div class="col-md-6">
          <div class="box-body">
            ...
            <option value="1" <?php if($all_data[0]['invite_type'] == 1){ ?> selected="" <?php } ?> >Public</option>
            <option value="2" <?php if($all_data[0]['invite_type'] == 2){ ?> selected="" <?php } ?> >Private</option>
            </select>
            </div>
          </div>
        </div>
      ...
      <div class="col-md-6">
        <div class="box-body">
          ...
          <input type="text" class="form-control" name="business_name" id="bsn_name" value="<?php echo $all_data[0]['business_name'];?>" id="business_name" placeholder="Delegate Space Name">
        </div>
      </div>
      ...
      <div class="col-md-6">
        <div class="box-body">
          ...
          <select class="js-example-basic-multiple form-control" name="cat_id[]"  id="bsn_cat_id" multiple="multiple">
            ...
            <option <?php if(in_array($cat_val['category_id'],$get_cate_val)){?> selected <?php } ?>  value="<?php echo $cat_val['category_id'];?>"><?php echo $cat_val['category_name'];?></option>
            <?php } } ?>
          </select>
        </div>
      </div>
        ...
        <div class="box-body">
          ...
          <input type="text" class="form-control" name="business_website_url" id="business_website_url" value="<?php echo $all_data[0]['business_website_url'];?>" id="business_website_URL" placeholder="Delegate Space Website URL">
        </div>
      </div>
        ...
        <div class="box-body">
          ...
          <input type="text" class="form-control" name="business_street" value="<?php echo $all_data[0]['business_street'];?>" id="autocomplete" onFocus="geolocate()" placeholder="Street Address">
        </div>
      </div>
      ...
      <div class="col-md-6">
        <div class="box-body">
          ...
          <input type="text" class="form-control" name="business_postal_code" value="<?php echo $all_data[0]['business_postal_code'];?>" id="bsn_postal_code" placeholder="Postal Code">
        </div>
      </div>
     ...
     <div class="col-md-6">
        ...
        <div class="col-md-12">
          ...
          <div class="box-body">
            <div class="upload">
              <label for="event_pic" id="photo-img-label">Upload Space Banner<span style="color:red">*</span></label>
                                                ...
                                                <div class="row">
                                                   <div class="select">
                                                      <select name="from_opening_indication<?php echo $k; ?>" id="from_opening_indication_[<?php echo $k; ?>]">
                                                         ...
                                                         <option <option <?php if(isset($opening_hour_from_arr[2])) { echo ($opening_hour_from_arr[2] == "PM") ? 'selected="selected"' : ''; }?> value="PM">PM</option>
                                                      </select>
                                                   </div>
                                                </div>
                                             </div>
      ...
      <div class="col-md-12">
          <div class="box-body">
          <label for="exampleInputAddress">Delegate Space Description</label>
            <textarea class="form-control" name="business_description" value="" id="business_description" placeholder="Space Description" rows="6"><?php echo $all_data[0]['business_description'];?></textarea>
          </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="box-body">
              ...
              <select class="form-control" name="business_status" id="business_status">
                ...
                <option value="Active" <?php if($all_data[0]['business_status'] == 'Active'){ ?> selected="" <?php } ?> >Active</option>
                <option value="Inactive" <?php if($all_data[0]['business_status'] == 'Inactive'){ ?> selected="" <?php } ?> >Inactive</option>
              </select>
              </div>
            </div>
          </div>
...
function invite_spave_validation()
{
	...
	var bsn_description = $("#business_description").val();
