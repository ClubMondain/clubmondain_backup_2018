    ...
    <div class="row">
      <div class="col-xs-12">
        <div class="box">
	      ...
	      ?>
              <tr>
                <td><a href="<?php echo  base_url('Home/profileProfile/').base64_encode($get_user_details['user_id']); ?>" target="_blank">
                <?php echo $get_user_details['first_name'].' '.$get_user_details['last_name'];?>
                </a>
                </td>
                ...
                <td><img src="<?php echo  site_url('upload/news_blog/').$all_members['blog_news_image']; ?>" style="width: 50px; height: 50px;" /></td>
                ...
                <a href="javascript:void(0);" onClick="return delete_member('<?php echo base_url('Dashboard/delete_news_two/'.$all_members['blog_news_id']); ?>');" data-toggle="tooltip" title="Delete"><i class="fa fa-trash"></i></a></td>
              </tr>
              <?php 
			  }
			  } 
