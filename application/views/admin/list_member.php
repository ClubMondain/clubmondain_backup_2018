  ...
  <section class="content-header">
   ...
   <!-- Main content -->
    <section class="content">
      ...
      <select class="form-control" name="membership" id="membership" onChange="shortingData('<?php echo base_url('Dashboard/list-member'); ?>',this.value)">
            ...
            <div class="box-body">
              <div class="table-responsive">
                ...
                <tr>
                    ...
                    <td><a href="<?php echo base_url('Dashboard/view-all-member-details/'.$all_members['user_id']);?>"><?php echo $all_members['first_name'].' '.$all_members['last_name']; ?></a></td>
                    ...
                    <td>
                    <a href="<?php echo base_url('Dashboard/edit-membership-view/'.$all_members['user_id']);?>" data-toggle="tooltip" title="Edit"><i class="fa fa-pencil"></i></a>&nbsp;&nbsp;&nbsp;
                ...
                ?>
                  <tr>
                    <td><input type="checkbox" name="chk[]" value="<?php echo $all_members['user_id'];?>"></td>
                    <td>
                    <a href="<?php echo base_url('Dashboard/view-all-member-details/'.$all_members['user_id']);?>">
